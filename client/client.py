...
def receive_file_segments(UDPClientSocket, fileSegments, fileSegmentNumber):
    try:
        while True:
        ...
        UDPClientSocket.settimeout(15)
        receive_file_segments(UDPClientSocket, fileSegments, fileSegmentNumber)
...
UDPClientSocket.settimeout(15) # Timeout of 30 seconds, would be changed if put into a production environment (as opposed to testing)
